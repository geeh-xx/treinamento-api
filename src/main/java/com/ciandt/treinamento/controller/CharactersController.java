...
public class CharactersController {
	...
	public List<Personagem> returnAllCharacters(@RequestParam(name = "limit", required = false) Integer limit) {
		if (limit < 20)
			return service.getCharacterList(limit);
		return service.getCharacterList(MarvelApiConstants.DEFAULT_LIMIT);
	}
